"""BluefrontNotes URL Configuration
...
urlpatterns = [
    ...
    path('password-reset/', auth_views.PasswordResetView.as_view(form_class=UserPasswordResetForm, template_name='users/password_reset.html'), name='password_reset'),
